class ServicosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @servico.save
        format.html { redirect_to @servico, notice: 'Criado com sucesso.' }
  ...
  def update
    ...
    respond_to do |format|
      if @servico.update_attributes(params[:servico])
        format.html { redirect_to @servico, notice: 'Atualizado com sucesso.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to servicos_url, notice: 'Apagada com sucesso.' }
      format.json { head :no_content }
    end
  end
end
